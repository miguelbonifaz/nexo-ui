...
export const componentMeta = {
  ...
  'detail-modal': {
    ...
    seoHeading: 'React Detail Modal with Tailwind CSS',
    seoDescription:
      'An accessible React detail modal styled with Tailwind CSS for reviewing records with keyboard, backdrop, and action support.',
  },
};
