...
export const numberedPaginationSnippet = String.raw`${iconPreamble}
...
export default function NumberedPagination() {
  return (
    <nav aria-label="Numbered pagination" className="flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-slate-200 bg-white px-5 py-4 dark:border-slate-800 dark:bg-slate-950">
